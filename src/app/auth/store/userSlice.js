...
export const setUserDataFirebase = (user, authUser) => async dispatch => {
	...
	return dispatch(createUserSettingsFirebase(authUser, user));
};

export const createUserSettingsFirebase = (authUser, userData) => async (dispatch, getState) => {
	...
	console.log('THIS IS USER DATA before change ----->', userData);
	...
	console.log('THIS IS USER DATA AFTER change ----->', user);
